...
const AddProductForm = function ({onCancel}: Props) {
    const {
        register,
        handleSubmit,
        formState: {errors},
    ...
    return <div>
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex flex-col mb-2 text-base">
                ...
                <input className="border-1 border-gray-300 py-1 px-2 rounded-md" id="title" type="text" {...register("title")}/>
                <p className="mt-1 text-red-500 text-sm">{errors.title?.message}</p>
            </div>
            <div className="flex flex-col mb-2 text-base">
                <label className="mb-1" htmlFor="price">Price</label>
                <input className="border-1 border-gray-300 py-1 px-2 rounded-md" id="price" type="number" {...register("price")}/>
                <p className="mt-1 text-red-500 text-sm">{errors.price?.message}</p>
            </div>
            <div className="flex flex-col mb-2 text-base">
                <label className="mb-1" htmlFor="description">Description</label>
                <textarea className="border-1 border-gray-300 py-1 px-2 rounded-md" id="description" {...register("description")}/>
            ...
            <div className="flex flex-col mb-8 text-base">
                ...
                <input className="border-1 border-gray-300 py-1 px-2 rounded-md" id="category" {...register("category")}/>
            ...
            <div className="flex items-stretch gap-2">
                ...
                <AccentButton className="flex-1">Create</AccentButton>
            </div>
        </form>
    </div>
}
