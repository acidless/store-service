    ...
    return <div>
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex flex-col mb-2 text-base">
                ...
                <input className="border-1 border-gray-300 py-1 px-2 rounded-md" id="price" type="number"
                       step="0.01" {...register(
            ...
            <div className="flex flex-col mb-8 text-base">
                ...
                <Select align="left" onOptionChange={onCategoryChange}
                        options={options}
                        defaultOption={product?.category ? options.findIndex(o => o.text === product?.category) : 0}/>
